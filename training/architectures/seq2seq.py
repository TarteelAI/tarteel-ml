...
def lstm_encoder_decoder_with_teacher_forcing_training(
        latent_dim, num_encoder_tokens, num_decoder_tokens):
...
def lstm_encoder_decoder_with_teacher_forcing_inference(
